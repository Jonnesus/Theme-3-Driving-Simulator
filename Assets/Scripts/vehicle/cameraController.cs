...
public class cameraController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        vehicleCamera.usePhysicalProperties = true;
        vehicleCamera.fieldOfView = fieldOfView;
    }
